...
VALUES ('Qualidade do Produto', '#4CAF50'),
...
VALUES ('EchoBox Solutions', 'contato@echobox.com', '12345678000100'),
...
VALUES ('Excelente Qualidade do Produto!',
        'O produto superou minhas expectativas em termos de qualidade e funcionalidades. Muito satisfeito com a compra.',
        2, 1, 1, 3),
       ('Resposta Lenta do Atendimento',
        'Levei vários dias para receber uma resposta do atendimento ao cliente. Pode ser melhorado.', 3, 2, 2, 2),
       ('Problemas de Navegação no Site',
        'Tive dificuldade para encontrar as informações que precisava no site. A navegação poderia ser mais intuitiva.',
        4, 1, 3, 1),
       ('Entrega Muito Rápida', 'Recebi meu pedido muito mais rápido do que esperava. Excelente logística!', 5, 3, 4,
        3),
       ('Preços Competitivos',
        'Os preços são muito competitivos para as funcionalidades oferecidas. Bom custo-benefício.', 6, 4, 5, 3),
       ('Bug no Aplicativo Mobile',
        'Encontrei um bug crítico ao usar o aplicativo mobile no Android. Não consegui finalizar a compra.', 7, 1, 6,
        2),
       ('Solicitação: Modo Escuro',
        'Adoraria ver uma opção de modo escuro no aplicativo. Melhoraria muito a experiência do usuário.', 8, 1, 7, 1),
       ('Experiência Geral Excelente', 'Tive uma experiência maravilhosa com seu serviço. Continue com o bom trabalho!',
        1, 1, 8, 3),
       ('Processo de Pagamento Muito Complexo',
        'O processo de pagamento tem muitas etapas. Poderia ser simplificado para melhor experiência do usuário.', 2, 2,
        3, 2),
       ('Documentação do Produto Precisa Melhorar',
        'A documentação do produto está incompleta e poderia ter mais exemplos.', 3, 3, 1, 1),
       ('Atendimento ao Cliente Fantástico',
        'A equipe de atendimento foi extremamente prestativa e resolveu meu problema rapidamente.', 4, 4, 2, 3),
       ('Embalagem de Entrega Excelente', 'Os itens chegaram em perfeitas condições graças à excelente embalagem.', 5,
        5, 4, 3);
...
VALUES ('Obrigado pelo seu feedback!',
        'Realmente apreciamos sua avaliação positiva. Ficamos felizes que você esteja satisfeito com a qualidade do nosso produto.',
        1, 1),
       ('Estamos trabalhando nisso',
        'Obrigado por nos alertar sobre isso. Estamos trabalhando para melhorar nossos tempos de resposta.', 2, 1),
       ('Melhorias na navegação em breve',
        'Anotamos seu feedback e estamos planejando um redesign do site para melhorar a navegação.', 3, 1),
       ('Ótimo saber!',
        'Ficamos felizes que nosso serviço de entrega atendeu suas expectativas. Obrigado pelo feedback!', 4, 1),
       ('Correção de bug em andamento',
        'Identificamos o problema e nossa equipe de desenvolvimento está trabalhando em uma correção. Atualização em breve.',
        6, 7),
       ('Modo escuro em consideração',
        'Esta é uma solicitação popular! Estamos avaliando a implementação do modo escuro para nossa próxima atualização principal.',
        7, 1),
       ('Revisão do processo de pagamento',
        'Estamos revisando nosso fluxo de pagamento baseado no feedback dos usuários. A simplificação é uma prioridade.',
        9, 1);